      ...
      <div className="jr-card">
        ...
        <div className={`jr-card-header-color text-center bg-${headerColor}`}>
          ...
          <div className="jr-card-hd-content text-white">
            <h2 className="text-white jr-font-weight-medium mb-1">Lundi</h2>
          ...
          <div className="d-flex flex-column">
            <div className="list-line-item">
              ...
              <div className="list-line-content">
                <h4 className={`mb-1 text-primary`}>Formation culture d'entreprise</h4>
                <p className="jr-fs-sm text-light">14:00 pm</p>
              </div>
            </div>
            ...
            <div className="list-line-item">
              ...
              <div className="list-line-content">
                <h4 className="text-danger mb-1">Théatre</h4>
                <p className="jr-fs-sm text-light">16:00 pm</p>
              </div>
            </div>
            ...
            <div className="list-line-item">
              ...
              <div className="list-line-content">
                <h4 className="text-success mb-1">Band musical</h4>
                <p className="jr-fs-sm text-light mb-0">17:00 pm</p>
              </div>
            </div>
