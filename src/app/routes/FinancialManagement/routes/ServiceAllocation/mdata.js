     ...
     tasks: [
       {
         id: 1,
         name: 'Mila Alba',
         title: [<span className="jr-link">Mila Alba</span>, ' left a 5star review on ',
       ...
       },
       {
         id: 2,
         name: 'Bob Builder',
         title: ['Callback request from ', <span className="jr-link">Bob
Builder</span>, ' for the property ',
       ...
       },
       {
         id: 3,
         name: 'Tom Moody',
         title: ['Congratulations to ', <span className="jr-link">Tom
Moody</span>,
           ' for joining 10+ club '],
         avatar: 'https://via.placeholder.com/150x150',
         imageList: [],
     ...
     tasks: [
       {
         ...
         title: ['Agent ',
           ...
           <span className="jr-link">Albama’s House</span>],
         avatar: '',
         imageList: ['https://via.placeholder.com/150x150',
...
'https://via.placeholder.com/150x150'],
       },
       {
         id: 6,
         name: 'Tom Moody',
         title: ['Welcome to a new agent ', <span className="jr-link">Tom
Moody in the Company</span>],
         avatar: 'https://via.placeholder.com/150x150',
         imageList: [],
       },
       {
