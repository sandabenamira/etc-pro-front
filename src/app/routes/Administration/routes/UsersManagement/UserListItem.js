...
const UserListItem =({photo,nom,prenom,role,email,Ntel,}) =>
        ...
        <tr style={{backgroundColor :"white",borderRadius:15}}>
            <th scope="row" 
            style = {{
            display:"flex", flexDirection: "row", textAlign: "center",backgroundColor:"#F5F5F5",borderTopLeftRadius:15,borderBottomLeftRadius:15}}>
                <div >
      <Avatar alt="Remy Sharp" src="https://www.atlassian.com/fr/dam/jcr:ba03a215-2f45-40f5-8540-b2015223c918/Max-R_Headshot%20(1).jpg" />
      </div>
            ...
            <td style = {{
             textAlign:"center",backgroundColor:"#F5F5F5",borderTopRightRadius:15,borderBottomRightRadius:15}}>{Ntel}
