            ...
            <Can
              ...
              yes={() => (
                <div className="d-flex flex-column ">
                  ...
                  <form
                    autoComplete="off"
                    onSubmit={this.props.handleSubmitStep3}
                  >
                    <br />
                    {this.props.values.open ? (
                      <>
                        ...
                        <div className="d-flex flex-row-reverse mt-2">
                          <Button
                            disabled={
                              // values.step2 &&
                              this.validationClickStep1()==true
                                ? true
                                : false
                            }
                            variant="contained"
                        ...
                        {values.step2 && (
                          <>
                            ...
                            {values.participantList.map(
                              (objParticipants, index) => (
                                <div className="d-flex flex-wrap flex-row mt-2">
                                  <div className="col-md-5 col-lg-3 col-sm-12 p-2 ">
                                    ...
                                    <Select
                                      ...
                                      options={values.agenceList.filter(
                                        (element) =>
                                          !values.agenceIds.includes(element.id)
                                      )}
                                      onChange={(e) =>
                                        this.props.handleChangeParticipant(
                                          e,
                                          "agence",
                                          index
                                        )
                                      ...
                                      onClick={() => {
                                        if (!objParticipants.isAdded) {
                                          if (
                                            objParticipants.agence.id !==
                                              undefined &&
                                            objParticipants.participants
                                              .length > 0
                                          ) {
                                            this.props.addNewListParticipant(
                                              index + 1
                                            );
                                          } else {
                                          }
                                        } else {
                                          this.props.deleteListParticipant(
                                            index
                                          );
                                        }
                                      }}
                                    >
                                      {objParticipants.isAdded ? (
                                        <RemoveIcon />
                                      ) : (
                                        <AddIcon />
                                      )}
                            ...
                            <div className="d-flex flex-row-reverse mt-2">
                              ...
                              disabled={
                                // values.step3 &&
                                this.validationClickStep2()==true
                                  ? true
                                  : false
                              }
                                variant="contained"
                            ...
                            {values.horaireList.map((horaireItem, index) => (
                              <div className="d-flex flex-wrap flex-row mt-2">
                                <div className="col-md-6 col-lg-3 col-sm-12 p-2">
                                  <MuiPickersUtilsProvider utils={DateFnsUtils}>
                                    <KeyboardDatePicker
                                      ...
                                      onChange={(e) =>
                                        this.props.handleChangeHoraire(
                                          e,
                                          "dateFormation",
                                          index
                                        )
                                ...
                                <div className="col-md-6 col-lg-2 col-sm-12 p-2 mt-1">
                                  ...
                                  <FormHelperText
                                    error={moment(
                                      horaireItem.startHour
                                    ).isAfter(horaireItem.endHour)}
                                  >
                                    {moment(horaireItem.startHour).isAfter(
                                      horaireItem.endHour
                                    ) ? (
