  ...
  return (
    <div className="media jr-featured-item">
      <div className="jr-featured-thumb">
        {
          uri ? (
            <img src={uri} alt="example" onError={(e) => {
      ...
      <div className="media-body jr-featured-content">
        <div className="jr-featured-content-left">
          ...
          <div className="d-flex flex-wrap mb-2">
            <p className="mr-3 mb-1"><span className="text-grey">Nombre d'éleves:</span> {number_students}</p>
            <p className="mr-3 mb-1"><span className="text-grey">N° SMS:</span> {number_sms}</p>
            <p className="mr-3 mb-1"><span className="text-grey">Mode Payment:</span> {mode_payment}</p>
          </div>
          <div className="d-flex flex-row">
            ...
            <p className="text-grey ml-4 mb-1">
              <i className={`zmdi zmdi-calendar-alt jr-fs-lg mr-2 d-inline-block align-middle`} />{<IntlMessages id="components.professor.formadd.date_end_contract" />}:{moment(contract_start_date).format(" Do MMM YY")}
            </p>
          </div>
        </div>
