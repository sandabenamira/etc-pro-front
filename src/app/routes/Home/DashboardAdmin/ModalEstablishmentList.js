...
import { userSignOut, showLicenceMessage } from '../../../../actions/Auth';
...
class ModalEstablishmentList extends Component {
  ...
  handleSubmit() {
    if (_.isEmpty(this.state.establishment.establishment.licence)) {
      ...
      this.props.dispatch(
        getSubjectModules(this.state.establishment.establishment_id, this.state.establishment.establishment.licence[0].schoolYear.id)
      );
      this.props.dispatch(
        getAssignementCourse(this.state.establishment.establishment_id, this.state.establishment.establishment.licence[0].schoolYear.id)
      );
      this.props.dispatch(
        getClassSettings(this.state.establishment.establishment_id, this.state.establishment.establishment.licence[0].schoolYear.id)
      );
      this.props.dispatch(
        getSubjectModules(this.state.establishment.establishment_id, this.state.establishment.establishment.licence[0].schoolYear.id)
      );
      ...
      this.props.dispatch(
        getSubjectSetting(this.state.establishment.establishment_id, this.state.establishment.establishment.licence[0].schoolYear.id)
      );
      // } else {
                ...
                <div className="col-md-12">
                  <div className="form-group">
                    <TextField
                      ...
                      fullWidth
                    >
                      {this.props.profile.establishments.map((establishment) => (
                        <MenuItem key={establishment.id} value={establishment}>
