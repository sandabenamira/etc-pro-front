  ...
  return (
    <div className="card package bg-white shadow">
     ...
     <div className="package-items">
      ...
      <Button variant="outlined" size="small" color="primary" className={classes.margin} style={{ borderRadius: '2rem' }}>
          Savoir Plus
        </Button>
        <Button variant="contained" size="small" color="primary" className={classes.margin} style={{ borderRadius: '2rem' }}>
          Se connecter
        </Button>
