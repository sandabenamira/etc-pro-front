...
export default class ListMoocsItem extends Component {
  render() {
  var things = [img1, img2, img3, img4];
  var thing = things[Math.floor(Math.random() * things.length)];
    return (
      <div className="card package bg-white shadow">
      <div className="package-header  lighten-1 text-white">
        <img
          src={thing}
          alt="Moocs"
      ...
      <div className="package-items">
        <div className="package-items package-items text-grey text-darken-3">
          <div style={{ fontWeight: "bold" }}>
            <strong>
              {" "}
              <IntlMessages id="added.by" />{" "}
            </strong>{" "}
            &nbsp; Mohamed Hosni
          </div>
          <div style={{ fontWeight: "bold" }}>
