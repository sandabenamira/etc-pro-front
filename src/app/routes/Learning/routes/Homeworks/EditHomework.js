    ...
    return (
      <Auxiliary>
        <Modal isOpen={this.props.editIsopen}>
          <ModalHeader toggle={cancelModal} className="modal-box-header bg-primary text-white">
            {<IntlMessages id="edit.homework.header" />}
          </ModalHeader>
          <br />
          <ModalBody>
            <>
              ...
              <form className="row " autoComplete="off" onSubmit={submitEditHomework}>
...
export default connect()(EditHomework);
