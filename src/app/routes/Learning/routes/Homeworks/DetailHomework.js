      ...
      <Auxiliary>
        <Modal isOpen={this.props.values.isOpenDetail}>
          <ModalHeader className="modal-box-header bg-primary text-white">
            ...
            <IconButton className="text-white" onClick={this.props.handleCancel}>
              <CloseIcon />
            </IconButton>
          </ModalHeader>
              ...
              <div className="d-flex flex-column bd-highlight mb-3">
                <div className="d-flex flex-row justify-content-start align-items-center p-4 col-lg-12 col-md-12 col-sm-12">
                  ...
                  <div className="p-2 col-lg-4">
                    ...
                    <TextField id="homeworkType" label={values.homeworkType.label} InputProps={{ disableUnderline: true }} />
                  </div>
                  <div className="pl-4 p-2 col-lg-4">
                    ...
                    <TextField id="homeworkType" value={values.subjectItem.label} InputProps={{ disableUnderline: true }} />
                  </div>
                </div>
                <div>
                  <hr
                ...
                <div className="d-flex flex-row flex-wrap justify-content-start align-items-start p-4 col-lg-12 col-md-12 col-sm-12">
                  <div className=" col-lg-3">
                    ...
                    <TextField id="classItem" value={values.classItem[0].label} InputProps={{ disableUnderline: true }} />
                  </div>
