      ...
      <RoleContext.Consumer>
        {({ role }) => (
          <div className="animated slideInUpTiny animation-duration-3">
            <ContainerHeader
              title={<IntlMessages id="model.timetable" />}
                          ...
                          <FormControl className="w-100 mb-2">
                            ...
                            >
                              <MenuItem value="">
                                <em>
                                  {
                                    <IntlMessages id="autocomplete.emploidutemps.none" />
                                  }
                                </em>
                              </MenuItem>
            ...
            >
              ...
              <DialogContent>
                <ul>
                  ...
                  <li>
                    {" "}
                    <IntlMessages id="room.name" />:{" "}
                    <span>{this.state.eventRoom}</span>
                  </li>
                  <li>
                    {" "}
                    <IntlMessages id="toDo.professor" />:{" "}
                    <span>
                      {this.state.eventProfessorName}{" "}
                      {this.state.eventProfessorSurname}
                    </span>
                  </li>
                  <Can
                    role={role}
