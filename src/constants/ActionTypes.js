...
export const HIDE_SUCCESS_MESSAGE_INSC = "HIDE_SUCCESS_MESSAGE_INSC";
...
export const HIDE_SUCCESS_MESSAGE_AGENCE="HIDE_SUCCESS_MESSAGE_AGENCE";
export const SHOW_ERROR_MESSAGE_AGENCE="SHOW_ERROR_MESSAGE_AGENCE";
export const HIDE_ERROR_MESSAGE_AGENCE="HIDE_ERROR_MESSAGE_AGENCE";
